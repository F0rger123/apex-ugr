...
const qaWorker = readFileSync(resolve(root, "wrangler.pr23-qa-api.jsonc"), "utf8");
...
assert.match(workflow, /apex-ugr-pr23-qa-api\\\\\.drummerforger\\\\\.workers\\\\\.dev/);
assert.match(workflow, /github\.ref == 'refs\/heads\/main'/);

assert.match(qaWorker, /"name": "apex-ugr-pr23-qa-api"/);
assert.match(qaWorker, /"database_name": "apex-ugr-pr23-qa"/);
assert.match(qaWorker, /"bucket_name": "apex-ugr-pr23-qa-media"/);
assert.doesNotMatch(qaWorker, /"database_name": "apex-ugr-db"/);
assert.doesNotMatch(qaWorker, /"bucket_name": "apex-ugr-media"/);
