...
const SEED_DRIVERS: DriverRadarMarker[] = [
  {
    id: 'd_seed_1',
    ...
    vehicle: { year: 2024, make: 'Nissan', model: 'GT-R Nismo' } as any,
  },
  {
    id: 'd_seed_2',
    ...
    vehicle: { year: 2023, make: 'Porsche', model: '911 GT3 RS' } as any,
  },
  {
    id: 'd_seed_3',
    ...
    vehicle: { year: 2024, make: 'BMW', model: 'M3 Competition' } as any,
  },
  {
    id: 'd_seed_4',
    ...
    vehicle: { year: 1998, make: 'Mazda', model: 'RX-7 FD3S' } as any,
  },
];

const INITIAL_MEETS: CarMeetWithHost[] = [
  {
    id: 'm_seed_1',
