...
function GameLobby({onEnter}:{onEnter:(tab:TabKey)=>void}){
  ...
  if(entering)return <PlayTransition carName={car?.nickname||'APEX PILOT'} onComplete={()=>onEnter('command')}/>;
