...
export const useLiveNetworkStore=create<LiveNetworkState>((set,get)=>({
  location:null,revealOrigin:null,drivers:[],events:[],cruises:[],route:null,navigationState:'idle',navigationStepIndex:0,navigationStopIndex:0,navigationStartedAt:null,remainingDistanceKm:0,remainingDurationMinutes:0,activeCruiseId:null,savedPlaces:[],savedRoutes:[],suggestions:[],networkStatus:'offline',error:null,isDriving:false,unit:'mph',distanceKm:0,maxSpeedKph:0,startedAt:null,shareMinutes:15,shareExpiresAt:null,driveTrace:[],lastDriveSummary:null,weeklyTopSpeedKph:0,_watch:null,_poll:null,_userId:null,_driveSessionId:null,
  initialize:async()=>{
